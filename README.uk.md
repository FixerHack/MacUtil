...
> Відкрийте програму один раз, потім **Системні параметри → Приватність і безпека → Все одно відкрити**. Після оновлення macOS може попросити знову.
...
1. Відкрийте [останній реліз](https://github.com/FixerHack/MacUtil/releases/latest) і завантажте **MacUtil-x.y.z.dmg**.
2. Відкрийте DMG і перетягніть **MacUtil** на теку **Applications** (Програми).
3. Виконайте кроки з розділу [Перший запуск](#перший-запуск). Вони є й у вікні DMG.

<p align="center"><img src="docs/dmg.png" alt="Вікно DMG з MacUtil" width="560"></p>

До кожного релізу також додано zip з програмою, якщо так зручніше.
...
Це потрібно зробити один раз після встановлення; після оновлення macOS може попросити знову. Те саме можна зробити в Терміналі:
